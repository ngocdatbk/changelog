	...
	<div class='box-wrap'>
		...
		<div class='box'>
			...
			<div class='form'><form method='post' id='authform' action='a/join'>
				...
				<?php hidden("sys", HTML::get("sys"));?>
			
				<div class='row'>
					<div class='label'>Your email</div>
					<div class='input disabled'><input type='text' name='email' readonly placeholder='Your email' value='<?php echo HTML::get("email");?>'></div>
				</div>
				...
				<div class='row'>
					...
					<div class='input-group xo'>
						<div class='input left half'><input type='text' name='first_name' placeholder='Your first name' value=''></div>
						<div class='input right half'><input type='text' name='last_name' placeholder='Your last name'></div>
					</div>
				</div>
				...
				<div class='row relative xo'>
					...
					<div class='submit' onclick='Account.join(this);'>Join to start working</div>
