			...
			.after(
				'<span class="minicolors-panel minicolors-slider-' + settings.control + '">' + 
					'<span class="minicolors-slider">' + 
						'<span class="minicolors-picker">'+
							'<span class="mini-icon mini-icon-left s16-apb-right2"></span> <span class="mini-icon mini-icon-right s16-apb-left2"></span>'+
						'</span>' +
					'</span>' + 
